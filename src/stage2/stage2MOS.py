...
if __name__ == '__main__':
    ...
    print(f"To use the remaining Unlabelled count if the value is not 0: {unlabeled_count}")
    print("-"*10)
    ...
    for run in range(3):
        ...
        for epoch in range(0,1001):
            ...
            if SRCC[0] > PREV_SRCC:
                ...
                ulloader = DataLoader(ulset, batch_size=12, shuffle=False, num_workers=4, collate_fn=trainset.collate_fn)
                name_score = {}
